...
class LeafInfo extends StatefulWidget {
  final LeafItems leafitem;
  const LeafInfo({
    Key? key,
    required this.leafitem,
  }) : super(key: key);

  @override
  State<LeafInfo> createState() => _LeafInfoState();
}

class _LeafInfoState extends State<LeafInfo> {
                      ...
                      child: Container(
                        ...
                        child: DChartBar(
                          data: [
                            {
                              ...
                              'data': [
                                {
                                  'domain': widget.leafitem.leafname,
                                  'measure': widget.leafitem.leafarea,
                                },
                              ],
                            },
                          ],
                          ...
                          barValue: (barData, index) {
                            return widget.leafitem.leafarea.toString();
                          },
                          borderWidth: 1,
                          ...
                          children: [
                            Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: Image(
                                  image:
                                      NetworkImage(widget.leafitem.leafimage),
                                  fit: BoxFit.fill,
                                ),
                              ),
                            ),
                                                  ...
                                                  Expanded(
                                                    child: Container(
                                                      ...
                                                      child: Padding(
                                                        ...
                                                        child: Text(widget.leafitem.leafname,
                    ...
                    children: [
                      ...
                      RichText(
                        ...
                        const TextSpan(
                            ...
                            style: TextStyle(
                                ...
                                color: Colors.black)),
                        TextSpan(
                          text: widget.leafitem.leafarea.toString(),
                          style: const TextStyle(
                              fontFamily: "Marathi",
                              fontSize: 26,
                              color: Colors.black),
                      ...
                      Row(
                        children: [
                          ...
                          Text(
                            widget.leafitem.leafrate.toString(),
                            style: const TextStyle(
                                fontFamily: "Marathi",
                                fontSize: 26,
                                color: Colors.black),
                        ...
                        text: TextSpan(children: [
                          ...
                          const TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)),
                          TextSpan(
                              text: widget.leafitem.leafpreni,
                              style: const TextStyle(
                                  fontFamily: "Marathi",
                                  fontWeight: FontWeight.normal,
                                  color: Colors.black,
                          ...
                          const TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)),
                          TextSpan(
                              text: widget.leafitem.leafvarity,
                              style: const TextStyle(
                                  fontFamily: "Marathi",
                                  fontWeight: FontWeight.normal,
                                  color: Colors.black,
                          ...
                          const TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)),
                          TextSpan(
                              text: widget.leafitem.leafsupliment,
                              style: const TextStyle(
                                  fontFamily: "Marathi",
                                  fontWeight: FontWeight.normal,
                                  color: Colors.black,
                          ...
                          const TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)),
                          TextSpan(
                              text: widget.leafitem.leafdeses,
                              style: const TextStyle(
                                  fontFamily: "Marathi",
                                  fontWeight: FontWeight.normal,
                                  color: Colors.black,
                          ...
                          const TextSpan(
                              ...
                              style: TextStyle(
                                  ...
                                  fontWeight: FontWeight.w600)),
                          TextSpan(
                              text: widget.leafitem.leafyield,
                              style: const TextStyle(
                                  fontFamily: "Marathi",
                                  fontWeight: FontWeight.normal,
                                  color: Colors.black,
